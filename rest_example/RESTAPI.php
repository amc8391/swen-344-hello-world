...
function get_person_by_id($id)
{
  ...
  switch ($id){
    case 1:
      $person_info = array("person_name" => "Dan Krutzfdsafds", "person_age" => "12", "favorite_movie" => "Bloodsport 2"); 
      break;
    case 2:
...
function get_person_list()
{
  //normally this info would be pulled from a database.
  //build JSON array
  $app_list = array(array("id" => 1, "name" => "Prof 1 by Alex Christodoulou"), array("id" => 2, "name" => "Prof 2"), array("id" => 3, "name" => "Prof 3"), array("id" => 4, "name" => "Prof 4")); 
